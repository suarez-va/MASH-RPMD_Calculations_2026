...
#SBATCH --output=/storage/project/r-jkretchmer3-0/vsuarez6/repos/MASH-RPMD_Calculations_2026/MASH-RPMD_System-Bath/low_friction/epsil_0/traj_grid/logs/task_%a.out
#SBATCH --error=/storage/project/r-jkretchmer3-0/vsuarez6/repos/MASH-RPMD_Calculations_2026/MASH-RPMD_System-Bath/low_friction/epsil_0/traj_grid/logs/task_%a.err
