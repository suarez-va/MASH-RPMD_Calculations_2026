...
CONFIG = {
    ...
    'n_traj'     : 1000000,             # number of independent trajectories to run
    ...
    'delt'           : 0.001,
    'total_time'     : 3.0,        # a.u.; Nsteps = total_time / delt
    'Nprint'         : 20,
    'langevin'       : 'generalized',
    'langevin_params': {'gamma': 2.00, 'Tmem': 0.005, 'Tfluc': 5.0},
    ...
    'equil_time'  : 0.005,   # a.u.; make >= a few * Tmem (=10) so memP fully fills and (R,P) relax
